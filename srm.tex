...
\begin{lemma}(Martingale property of posterior odds under the null hypothesis)
  ...
  \noindent Let $\bx_i,$ be a sequence of $\text{Multinomial}(1,\btheta)$ random variables and consider the sequence of posterior odds $O_n(\btheta_0)$ defined as in Equation \eqref{eq:update_rule} with $O_0(\btheta_0)=1$, then $O_n(\btheta_0)$ is a non-negative martingale under $M_0$.
