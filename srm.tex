...
for all $u \in [0,1]$ and for all choices of $\balpha_0$.
\end{thm}
\noindent Each $I_n(u)$ is a convex subset of $\triangle^d$ (convexity following from concavity of the multinomial log-likelihood). \todo{justify this claim}
...
\todo[inline]{I would argue that this shouldn't be a corollary unless you provide a closed form solution of $j_{n,i}^l(i)$; otherwise, I think it should be a remark}
